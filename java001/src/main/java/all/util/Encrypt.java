...
public class Encrypt {
	...
	public static final String KEY = "KittySnoopyMicky";  //16*8, 24*8, 32*8
...
//		System.out.println(getMD5Endocing(file));
		String pswd = "2";
		String enpswd = getMD5Endocing(encryptString(pswd));
		System.out.println(enpswd);
		//System.out.println(decryptString(KEY, enpswd));

...
public class JavaMailUtil {
	...
	public JavaMailUtil(String from, List<String> to, List<String> cc,
			List<String> bcc, String subject, String text,
			List<String> attachment) {
	...
	public boolean send() {
		try {
			...
			if (msg.indexOf("Please log in via your web browser") > 0) {
				System.out
						.println("請到https://www.google.com/settings/security/lesssecureapps");
	...
	public void createSession() {
		...
		Authenticator au = new javax.mail.Authenticator() {
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("tlap08609", "2xrxxdlx");
			}
		};
